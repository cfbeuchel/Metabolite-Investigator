custom_corrplot <- function (corr, method = c("circle", "square", "ellipse", "number", 
                     ...
                     win.asp = 1, ...) 
{
  ...
  if (method == "square" && plotCI == "n") {
    corrplot:::draw_method_square(Pos, DAT, asp_rescale_factor, col.border, 
                       col.fill)
  }
  if (method == "color" && plotCI == "n") {
    corrplot:::draw_method_color(Pos, col.border, col.fill)
  }
