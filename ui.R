    ...
    sidebarLayout(
      sidebarPanel(width = 3,
                   ...
                   checkboxInput("button.choose.prepro",
                                 ...
                                 value = T),
                   helpText("Please select the pre-processing steps you would like to perform:"),
    ...
    sidebarLayout(
      sidebarPanel(width = 3,
                   ...
                   sliderInput("corr.cut.slider",
                               ...
                               sep = "."),
                   tags$hr(),
                   helpText("You can show the pairwise correlation of its factors."),
                   selectInput(inputId = "plot.corr.select", label = "Display Correlation in Study", multiple = F, choices = NULL),
                   tags$hr(),
                   helpText("This panel displays factors correlated above the specified threshold to be removed."),
      ...
      sidebarPanel(width = 3,
                   conditionalPanel(
                     ...
                     sliderInput(inputId = "r.squared.cutoff.slider",
                                 label = "Threshold for explained variance",
                                 min = 0,
                                 max = 0.2,
                                 value = 0.025,
                                 step = 0.001,
                                 sep = "."),
                     textInput(inputId = "r.squared.cutoff.text", 
                               label = NULL, 
                               value = 0.025),
                     tags$hr(),
                     selectInput(inputId = "multiple.testing.correction.selecter",
                                 ...
                                 selected = "hierarchical.bf"),
                     tags$hr(),
                     helpText("Select factors to be force-included into multivariable association analysis."),
                     ...
                     sliderInput(inputId = "missingness.cutoff.slider",
                                 label = "Threshold for Factor missingness",
                                 min = 0,
                                 max = 1,
                                 value = 0.1,
                                 step = 0.01,
                   ...
                   conditionalPanel(
                     condition = "input.ChangeBasedOnThis != 'Plot/<br/>Settings' && input.ChangeBasedOnThis != 'Description/<br/>Settings'",
                     helpText("Download results of factor selection step:"),
                     tags$hr(),
